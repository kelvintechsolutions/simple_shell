...
/**
 * struct liststr - a singly linked list function
 * @num: first parameter
 ...
 *@cmd_buf: address of pointer to cmd_buf, on if chaining occurs
 *@cmd_buf_type: CMD_type ||, &&, ;
 *@readfd: reads the line input
 *@histcount: history count function
 */
...
/**
 *struct builtin - buiiltin string and its realted function
...
int working_environment(info_t *);
int _myworkingenvironment(info_t *);
int _mydormenvironment(info_t *);
int pop_environment_list(info_t *);
